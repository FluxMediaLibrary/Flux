...
const navigationContracts = {
  ...
  SearchScreen: ["queryChanged", "mediaSelected", "recentSelected"],
  DetailsScreen: ["playSelected", "mediaSelected", "seasonSelected"],
  SeasonScreen: ["episodeSelected", "backRequested", "focusIndex"],
  EpisodeScreen: ["playSelected", "backRequested"],
  PlayerScreen: ["progressEvent", "stopped", "nextRequested", "audioTrackSelected"],
